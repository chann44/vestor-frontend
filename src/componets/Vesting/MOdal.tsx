      ...
      <div className="w-full pt-12">
        <div className=" space-y-3">
          {MOdalpoints.map((point: string, index: number) => {
            return (
              <div className="flex space-x-4 items-center text-text-faded">
        ...
        <div className="flex space-x-4  items-center mt-12 ">
          ...
          >
            ...
            <span className="space-x-3">
              <FaGasPump className="text-text ml-6" />
            </span>
          </button>
        </div>
      </div>
...
export const MOdal = () => {
  ...
  return (
    <div
      ...
      className=""
    >
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-[#383838] bg-opacity-90 rounded-xl">
